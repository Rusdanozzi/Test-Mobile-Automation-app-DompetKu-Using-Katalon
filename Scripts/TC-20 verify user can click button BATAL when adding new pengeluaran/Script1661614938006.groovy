...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - BATAL'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Pengeluaran (1)'), 'Pengeluaran')
